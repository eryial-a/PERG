...
{
    // Toggle Slider Code, everything below works to make a slider automatically move from one side to another when clicked, supports groups of toggles
    [Header("Slider setup")]
